...
command_str = 'docker run --gpus all -v {0:}:/data -w /data/DA_Observer/CLB_FDA/predator/ -it --user $(id -u):$(id -g) shenghh2020/tf_gpu_py3.5:latest sh {1:}'.format(data_folder, job_file_name)
print(command_str)
