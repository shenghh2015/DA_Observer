...
python adda_DA.py --gpu 2 --shared True --lr 1e-5 --d_lr 1e-5 --g_lr 1e-5 --iters 200000 --bz 300 --scratch False --nb_source 100000 --nb_target 100000 --dis_bn True --t_blur 3.0