...
python --gpu 0 --docker False --dis_cnn 2 --g_cnn 6 --g_lr 1e-4 --d_lr 4e-4 --lsmooth True --dis_bn False --iters 100000 --bz 300 --dis_param 1.0 --trg_clf_param 0 --src_clf_param 1.0 --ng_trg_labels 0 --dataset total
