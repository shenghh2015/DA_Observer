...
python mmd_DA3.py --gpu 0 --docker True --lr 1e-5 --iters 200000 --bz 300 --mmd_param 1.0 --trg_param 1.0 --src_clf_param 1.0 --scratch True --nb_source 100000 --nb_target 85000 --bn True --valid 100
