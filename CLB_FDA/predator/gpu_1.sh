...
python adda_DA3.py --gpu 1 --docker True --dis_cnn 0 --g_cnn 6 --source_scratch False --g_lr 1e-5 --d_lr 1e-4 --lsmooth False --dis_bn True --den_bn True --iters 100000 --bz 200 --dis_param 1.0 --trg_clf_param 0 --src_clf_param 1.0 --nb_trg_labels 0 --dataset total