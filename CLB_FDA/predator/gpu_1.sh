...
python adda_DA3.py --gpu 1 --docker True --dis_cnn 4 --g_cnn 4 --source_scratch True --g_lr 1e-5 --d_lr 5e-4 --lr 5e-6 --lsmooth False --dis_bn True --den_bn True --iters 400000 --bz 200 --dis_param 1.0 --trg_clf_param 0 --src_clf_param 1.0 --nb_trg_labels 0 --dataset dense --drop 0.5