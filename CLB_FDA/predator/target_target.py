...
for model_folder in model_folders:
	if os.path.isdir(model_folder) and os.path.exists(model_folder+'/model-0.meta'):
		...
		meta_best_new = os.path.join(os.path.dirname(model_best), '{}-{}.meta'.format('target', 'best'))
		index_best_new = os.path.join(os.path.dirname(model_best), '{}-{}.index'.format('target', 'best'))
		data_best_new = os.path.join(os.path.dirname(model_best), '{}-{}.data-00000-of-00001'.format('target', 'best'))
