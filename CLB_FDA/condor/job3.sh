...
python train_target.py --gpu_num 1 --docker False nb_cnn 4 --bn False --lr 1e-5 --nb_train 200 --bz 50 --nb_steps 25000 --optimizer Adam --dataset total
python train_target.py --gpu_num 1 --docker False nb_cnn 4 --bn False --lr 1e-5 --nb_train 300 --bz 50 --nb_steps 25000 --optimizer Adam --dataset total
