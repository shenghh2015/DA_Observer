...
bsub -G compute-anastasio -n 4 -R 'span[ptile=4] select[mem>120] rusage[mem=120GB]' -q general -a 'docker(shenghh2020/tf_gpu_py3.5:latest)' -gpu "num=4" /bin/bash /home/shenghuahe/DA_Observer/CLB_FDA/v100_cluster/train_target.sh