...
### Apr. 23, 2020
python train_DA1.py --gpu 0 --dis_cnn 2 --dis_fc 128 --dis_bn True --D_lr 1e-4 --G_lr 1e-4 --nD 1 --nG 1 --dAcc1 0.80 --dAcc2 0.95 --iters 10 --bz 400 --lamda 1.0
python train_DA1.py --gpu 1 --dis_cnn 2 --dis_fc 128 --dis_bn True --D_lr 1e-5 --G_lr 1e-5 --nD 1 --nG 1 --dAcc1 0.80 --dAcc2 0.95 --iters 200000 --bz 400 --lamda 1.0
python train_DA1.py --gpu 2 --dis_cnn 2 --dis_fc 128 --dis_bn True --D_lr 1e-6 --G_lr 1e-6 --nD 1 --nG 1 --dAcc1 0.80 --dAcc2 0.95 --iters 200000 --bz 400 --lamda 1.0
python train_DA1.py --gpu 3 --dis_cnn 2 --dis_fc 128 --dis_bn True --D_lr 1e-7 --G_lr 1e-7 --nD 1 --nG 1 --dAcc1 0.80 --dAcc2 0.95 --iters 200000 --bz 400 --lamda 1.0
python train_DA1.py --gpu 4 --dis_cnn 4 --dis_fc 128 --dis_bn True --D_lr 1e-5 --G_lr 1e-5 --nD 1 --nG 1 --dAcc1 0.80 --dAcc2 0.95 --iters 200000 --bz 400 --lamda 1.0
python train_DA1.py --gpu 5 --dis_cnn 4 --dis_fc 128 --dis_bn True --D_lr 1e-6 --G_lr 1e-6 --nD 1 --nG 1 --dAcc1 0.80 --dAcc2 0.95 --iters 200000 --bz 400 --lamda 1.0
python train_DA1.py --gpu 6 --dis_cnn 4 --dis_fc 128 --dis_bn True --D_lr 1e-7 --G_lr 1e-7 --nD 1 --nG 1 --dAcc1 0.80 --dAcc2 0.95 --iters 200000 --bz 400 --lamda 1.0
