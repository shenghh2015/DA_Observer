...
python mmd_DA.py --gpu 6 --docker False --shared True --source_scratch False --den_bn False --lr 5e-5 --iters 500000 --bz 400 --nb_trg_labels 300 --mmd_param 1.0 --src_clf_param 1.0 --trg_clf_param 0.7 --clf_v 1 --dataset total --valid 100
