...
# Apr. 27, 2020
JOB: python train_target.py --gpu_num 0 --nb_cnn 4 --bn False --lr 1e-5 --nb_train 500 --bz 400 --optimizer 'Adam' --nb_steps 20000
JOB: python train_target.py --gpu_num 1 --nb_cnn 4 --bn False --lr 1e-5 --nb_train 1000 --bz 400 --optimizer 'Adam' --nb_steps 20000
JOB: python train_target.py --gpu_num 2 --nb_cnn 4 --bn False --lr 1e-5 --nb_train 5000 --bz 400 --optimizer 'Adam' --nb_steps 20000
JOB: python train_target.py --gpu_num 3 --nb_cnn 4 --bn False --lr 1e-5 --nb_train 10000 --bz 400 --optimizer 'Adam' --nb_steps 20000
